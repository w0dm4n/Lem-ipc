...
*/
void				init_lemipc();
TL					*get_lemipc(int seg_id);
TL					*alloc_lemipc(int seg_id, sem_t *sem);
void				end_lemipc(TL *lemipc);
void				print_result(TL *lemipc);
...
**	MAP
*/
t_player			*get_player_on_cell(TL *lemipc, int x, int y);
void				update_map_pos(TL *lemipc, t_player *player);

/*
**	PLAYER
*/
t_player			*find_player_by_id(int id, TL *lemipc);
t_player			*add_new_player(int team_id, TL *lemipc);
int					count_alive_players(TL *lemipc);
t_player			*get_first_alive_player(TL *lemipc);
void				die(t_player *player, TL *lemipc);
void				set_pos(int x, int y, t_player *player, TL *lemipc);
BOOL				set_spawn_position(TL *lemipc, t_player *player);
t_player			*get_free_player(TL *lemipc);

/*
**	TIMELINE
*/
void				init_timeline(TL *lemipc);
void				timeline(t_player *player, TL *lemipc);
BOOL				get_next_player_turn(t_timeline *timeline, TL *lemipc);
...
**	IA
*/
void				ia_actions_handler(t_player *player, TL *lemipc);
t_player			*find_nearest_enemy(t_player *player, TL *lemipc);
...
**	MATES
*/
int					count_mates(t_player *player, TL *lemipc);
t_player			*find_nearest_friend(t_player *player, TL *lemipc);

/*
**	MAP
*/
BOOL				is_cell_free(int x, int y, TL *lemipc);
void				reset_map_pos(TL *lemipc, t_player *player);

/*
**	RADIUS
*/
void				find_players_around(t_player *players, t_player *player,
	TL *lemipc, int radius);
...
t_player			*find_player_by_radius(int radius, t_player *player,
	t_target *targets, int len, TL *lemipc);
...
int					get_all_possible_enemy(t_player *player, t_target *targets,
	TL *lemipc);
int					get_all_possible_players(t_player *player,
	t_target *targets, TL *lemipc);
...
**	DEAD
*/
void				player_dead(t_player *players, t_player *player,
	TL *lemipc);
#endif
